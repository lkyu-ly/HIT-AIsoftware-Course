...
class MLP(Module):
    ...
    def __init__(self, n_inputs):
        ...
        kaiming_uniform_(self.hidden1.weight, nonlinearity="relu")  # 适用于ReLU激活函数
        self.act1 = ReLU()
        # second hidden layer
        self.hidden2 = Linear(10, 8)
        kaiming_uniform_(self.hidden2.weight, nonlinearity="relu")  # 适用于ReLU激活函数
        self.act2 = ReLU()
        # third hidden layer and output
        self.hidden3 = Linear(8, 1)
        xavier_uniform_(self.hidden3.weight)  # 适用于Sigmoid激活函数
        # Sigmoid激活函数，用于输出层的输出，将结果压缩到0到1之间，适合二分类问题的概率输出。
        self.act3 = Sigmoid()
